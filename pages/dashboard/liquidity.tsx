		...
		<div className="space-y-8">
			...
			<div>
				...
				<p className="text-usdu-black">
					Provide or remove liquidity from the USDU/USDC pool. Choose
					the optimal route based on current pool conditions.
				</p>
			</div>
							...
							<div className="space-y-3">
								<div className="bg-white p-3 rounded-lg">
									<div className="flex items-center space-x-2 mb-2">
										<FontAwesomeIcon
											icon={faInfoCircle}
											className="w-4 h-4 text-usdu-orange"
										/>
										<p className="font-medium text-usdu-black">
											Best Route
										</p>
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<div className="bg-usdu-bg p-6 rounded-xl border border-usdu-surface">
					<div className="flex items-center space-x-3 mb-4">
						...
						/>
						<h3 className="text-lg font-bold text-usdu-black">
							Direct Pool
						</h3>
					</div>

					<p className="text-text-secondary mb-4">
						Interact directly with the Curve pool using standard
				...
				<div className="bg-usdu-bg p-6 rounded-xl border border-usdu-surface">
					...
					<p className="text-text-secondary mb-4">
						Use the protocol adapter to mint USDU and balance the
						pool for better pricing.
					</p>
					...
					<div className="mt-3 p-3 bg-white rounded-lg">
						<p className="text-xs text-text-secondary">
							...
							/>
							Adapter only supports adding USDC liquidity when
							pool is imbalanced
						</p>
					</div>
				</div>
