			...
			<div className="container mx-auto px-4">
				<motion.div
					...
					<p className="text-xl text-text-secondary max-w-3xl mx-auto">
						USDU serves as the foundational infrastructure for
						next-generation financial applications, providing stable
						funding for institutional-grade use cases.
					</p>
				</motion.div>
				...
				<motion.div
					...
					<div className="bg-usdu-black rounded-2xl p-8">
						<h3 className="text-2xl font-bold text-usdu-card mb-4">
							Ready to Build with USDU?
						</h3>
						<p className="text-usdu-card mb-6 max-w-2xl mx-auto">
							Explore how USDU can power your next-generation
							financial application with stable, predictable
