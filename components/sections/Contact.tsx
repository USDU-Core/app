...
const communityLinks = [
	{
		title: 'GitHub',
		description:
			'Explore our open-source codebase and contribute to USDU protocol development.',
	...
	},
	{
		title: 'Twitter',
		description:
			'Follow us for the latest updates, announcements, and insights from the USDU team.',
		url: SOCIAL.Twitter,
		icon: faXTwitter,
	},
	{
		title: 'Telegram',
		description:
			'Join our community discussion and get real-time support from our team.',
		url: SOCIAL.Telegram,
		icon: faTelegram,
	},
];
			...
			<div className="container mx-auto px-4">
				<motion.div
					...
					<p className="text-xl text-text-secondary max-w-3xl mx-auto">
						Connect with developers, institutional users, and the
						USDU team. Stay updated on protocol developments,
						governance decisions, and ecosystem growth.
					</p>
				</motion.div>
				...
				<motion.div
					...
					<p className="text-text-secondary mb-8 max-w-2xl mx-auto">
						Access the USDU protocol through our secure dashboard
						and start building with institutional-grade stablecoin
						infrastructure.
					</p>
