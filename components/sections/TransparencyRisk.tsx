      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-usdu-black mb-2">Live Risk Metrics</h3>
            <p className="text-text-secondary">Real-time protocol health indicators</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {riskMetrics.map((metric) => (
              <div key={metric.label} className="text-center">
                ...
                <div className="text-sm font-medium text-usdu-black mb-1">{metric.label}</div>
        ...
        >
          <div className="bg-usdu-bg p-8 rounded-xl border border-usdu-surface">
            ...
            <p className="text-text-secondary mb-6">
              Decentralized governance through DAO voting ensures transparent decision-making for
              protocol parameters, risk limits, and strategic direction.
            </p>
            <a
